...
namespace tau23mu
{
        ...
        const std::string & trackType)
    {
      ...
      if (trackType == "PF")         return muon.fits.at(tau23mu::MuonFitType::DEFAULT).charge;
      else if (trackType == "TUNEP") return muon.fits.at(tau23mu::MuonFitType::TUNEP).charge;
      else if (trackType == "GLB")   return muon.fits.at(tau23mu::MuonFitType::GLB).charge;
      else if (trackType == "INNER") return muon.fits.at(tau23mu::MuonFitType::INNER).charge;
      else if (trackType == "PICKY") return muon.fits.at(tau23mu::MuonFitType::PICKY).charge;
      else if (trackType == "DYT") return muon.fits.at(tau23mu::MuonFitType::DYT).charge;
      else if (trackType == "TPFMS") return muon.fits.at(tau23mu::MuonFitType::TPFMS).charge;
        ...
        const std::string & trackType)
    {
      ...
      tau23mu::MuonFit fit;
      if (trackType == "PF")
        fit = muon.fits.at(tau23mu::MuonFitType::DEFAULT);
      else if (trackType == "TUNEP")
        fit = muon.fits.at(tau23mu::MuonFitType::TUNEP);
      else if (trackType == "GLB")
        fit = muon.fits.at(tau23mu::MuonFitType::GLB);
      else if (trackType == "INNER")
        fit = muon.fits.at(tau23mu::MuonFitType::INNER);
      else if (trackType == "PICKY")
        fit = muon.fits.at(tau23mu::MuonFitType::PICKY);
      else if (trackType == "DYT")
        fit = muon.fits.at(tau23mu::MuonFitType::DYT);
      else if (trackType == "TPFMS")
        fit = muon.fits.at(tau23mu::MuonFitType::TPFMS);
      else
      {
    ...
    reco::Muon minPMu(reco::Muon mu1, reco::Muon mu2){
      return mu1.p()<mu2.p()?mu1:mu2;
    }

    reco::Muon  maxPMu(reco::Muon mu1, reco::Muon mu2){
      return mu1.p()>mu2.p()?mu1:mu2;
    }
 }
#endif
